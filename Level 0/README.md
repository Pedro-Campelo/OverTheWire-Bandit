...
## Background Research
Before attempting this level, I had never used or heard of SSH before. So rather than copying the command directly, I searched up 'What is SSH, What does it do and how do i use it'
...
Using this information i substituted them into the command and ended up running the command

```bash
ssh bandit0@bandit.labs.overthewire.org -p 2220
```
When i connected for the first time my computer reported that the authenticity of the host couldn't yet be verfied. This happens because my computer has not yet connected to this server before, so i verified the servers identity by
